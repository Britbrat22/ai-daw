...
const BACKEND = "http://localhost:8000"; // change later if you host backend
...
export default function App() {
  ...
  async function addFiles(files: FileList) {
    ...
    try {
      ...
      for (const f of arr) newTracks.push(await decodeFileToTrack(f));
  ...
  function onPlayPause() { setPlaying(p => !p); }
  function onStop() { setPlaying(false); setTime(0); pushLog("Stopped."); }
